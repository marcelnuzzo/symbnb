...
class Booking
{
     ...
     * @Assert\Date(message="Attetion, la date d'arrivée doit être au bon fomat !")
     * @Assert\GreaterThan("today", message="La date d'arrivée doit être ultérieure  la date d'aujourd'hui !", groups={"front"})
     */
    private $startDate;

    /**
     * @ORM\Column(type="datetime")
     * @Assert\Date(message="Attetion, la date de départ doit être au bon fomat !")
