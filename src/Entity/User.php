...
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=8, minMessage="Votre introduction doit faire au minimum 8 caractères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=80, minMessage="Votre description doit faire au minimum 80 caractères")
     */
    private $description;
